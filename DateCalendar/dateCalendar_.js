...
( function ( window, document, undefined ) {
	...
	console.info( ' *written by likun on 2018-04-03* ' );
	...
	DateCalendar.prototype = {
		...
		fillTable : function ( year, month, dateCalendarId ) {
			...
			self.posiCenter( calendarDom );

		},
		freshTds : function ( tableDom, year, month ) {
			//刷新表格日期数据
		...
		initMonthArr : function ( year, month ) {
			//初始化某月的数组数据
